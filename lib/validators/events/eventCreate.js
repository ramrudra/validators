...
var createSchema = exports.createSchema = _yup2.default.object().shape({
  ...
  endDate: _yup2.default.string().nullable(true).test('event-dates', 'End Date is required', function (value) {
    // eslint-disable-line
    ...
    return true;
  }).test('event-dates', 'End Date should be greated than Start Date', function (value) {
    // eslint-disable-line
    var parent = this.parent;
    var startDate = parent.startDate;
    if (_lodash2.default.isNull(startDate)) {
